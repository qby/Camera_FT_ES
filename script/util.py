...
Scenes            = ['auto', 'landscape', 'portrait', 'night', 'night-portrait' , 'sports', 'barcode'] #_0_0
...
CONFIRM_MODE_LIST       = ['video','single','depth','panorama','burst','perfectshot','smile','burstfast']
...
class TouchButton():
    ...
    def confirmCameraMode(self,mode):
        ...
        if  mode_index != currentindex:
            #print str(mode_index) + '+' + str(currentindex)
    ...
    def captureAndCheckPicCount(self,capturemode,delaytime=0):
        ...
        time.sleep(delaytime+3) #Sleep a few seconds for file saving
